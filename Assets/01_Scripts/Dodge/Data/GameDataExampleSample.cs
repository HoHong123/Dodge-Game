...
namespace Dodge.Data {
    [Serializable]
    public class GameDataExampleSample : ScriptableObject {
        #region Classes
        [Serializable]
...
#if UNITY_EDITOR
        public static GameDataExampleSample FromJson(JToken json, string iconFolderPath, string prefabFolderPath) {
            var data = new GameDataExampleSample();
